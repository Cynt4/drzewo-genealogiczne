...
Projekt posiada zaawansowaną konfigurację testową, która rozwiązuje typowe problemy automatyzacji, takie jak *Test Pollution* (zanieczyszczanie danych) oraz *Race Conditions* (wyścig wątków).
...
npm run test:e2e
```
*Skrypt ten automatycznie uruchomi serwer ze zmienną środowiskową przypinającą go do testowej bazy danych, a następnie wykona testy Playwright.*
